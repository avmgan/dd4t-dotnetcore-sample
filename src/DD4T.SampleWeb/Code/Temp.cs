...
{
    public class MyDD4TConfiguration : IDD4TConfiguration
    {
        public MyDD4TConfiguration()
        {
        }
...
//using DD4T.ContentModel.Contracts.Loggin
...
//    ///
//    /// </summary>
//    public class MyPageFactory : FactoryBase, IPageFactory
//    {
...
//        public MyPageFactory(IPageProvider pageProvider, IComponentPresentationFactory componentPresentationFactory,
...
//                    //}
//                    _serializerService = new MyAutoDetectSerializerService();
//                }
...
//    internal class MyAutoDetectSerializerService : ISerializerService
//    {
